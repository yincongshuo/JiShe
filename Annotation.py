...
class AnnotationApp(MyApp):
    def __init__(self):
        ...
        self.startDrawingButton.clicked.connect(self.start_drawing)
        self.addAnnotationButton.clicked.connect(self.add_annotation)
        self.saveAnnotationsButton.clicked.connect(self.save_annotations)
        self.loadAnnotationsButton.clicked.connect(self.load_annotations)
        self.clearAnnotationsButton.clicked.connect(self.clear_annotations)
        self.colorButton.clicked.connect(self.choose_color)
        self.penWidthSpinBox.valueChanged.connect(self.update_pen_width)
        self.annotationTypeComboBox.currentIndexChanged.connect(self.change_annotation_type)
